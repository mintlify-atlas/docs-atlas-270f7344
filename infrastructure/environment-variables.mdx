---
title: "Environment Variables for backtest-kit Docker Stack"
sidebarTitle: "Env Variables"
description: "Complete reference for all CC_* app variables and Docker CLI flags, with defaults, Postgres connection string, and Redis credentials."
---
