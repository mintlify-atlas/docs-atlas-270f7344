---
title: "Atomic Upserts: INSERT ON CONFLICT DO UPDATE RETURNING"
sidebarTitle: "Atomicity"
description: "Atomic INSERT … ON CONFLICT … DO UPDATE … RETURNING removes read-then-write races and replica-lag violations in the backtest-kit persistence layer."
---
