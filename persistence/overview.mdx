...
description: "How the 16 backtest-kit persist adapters wire PostgreSQL via TypeORM and Redis via BaseMap, replacing file-based storage with production-grade persistence."
---
