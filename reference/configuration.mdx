...
description: "All environment variables, npm scripts, TypeScript compiler options, and Rollup bundler settings for backtest-kit-redis-postgres-pgpool-docker."
---
