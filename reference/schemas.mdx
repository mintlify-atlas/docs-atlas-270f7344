...
description: "Complete reference for all 16 TypeORM EntitySchema definitions, their columns, PostgreSQL types, unique indexes, and the epochTransformer for bigint timestamps."
---
